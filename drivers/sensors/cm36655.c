	...
	struct cm36655_platform_data *pdata)
{
	...
	SENSOR_INFO("DefaultTHS[%d/%d] CancelTHD[%d/%d] PS_THD[%x] TRIM[%d] DEFENCE[%d]\n",
		pdata->default_hi_thd, pdata->default_low_thd,
		pdata->cancel_hi_thd, pdata->cancel_low_thd,
		ps_reg_init_setting[PS_THD][CMD], pdata->default_trim, pdata->is_defence);
	return 0;
}
#else
